...
func (p *kClient) CreateActivity(ctx context.Context, req *activity.CreateActivityReq) (r *activity.CreateActivityResp, err error) {
...
func (p *kClient) GetActivity(ctx context.Context, req *activity.GetActivityReq) (r *activity.GetActivityResp, err error) {
